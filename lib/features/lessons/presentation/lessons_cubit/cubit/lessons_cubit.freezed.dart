...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LessonsState<T>);
}
...
/// @nodoc
class $LessonsStateCopyWith<T,$Res>  {
$LessonsStateCopyWith(LessonsState<T> _, $Res Function(LessonsState<T>) __);
}


/// Adds pattern-matching-related methods to [LessonsState].
extension LessonsStatePatterns<T> on LessonsState<T> {
...
class _Initial<T> implements LessonsState<T> {
  const _Initial();
...
class _Loading<T> implements LessonsState<T> {
  const _Loading();
...
class Success<T> implements LessonsState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $LessonsStateCopyWith<T, $Res> {
...
class Error<T> implements LessonsState<T> {
...
@override
String toString() {
  return 'LessonsState<$T>.error(message: $message)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $LessonsStateCopyWith<T, $Res> {
