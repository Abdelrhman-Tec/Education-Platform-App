...
class _Failure<T> implements CartState<T> {
...
@override
String toString() {
  return 'CartState<$T>.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<T,$Res> implements $CartStateCopyWith<T, $Res> {
