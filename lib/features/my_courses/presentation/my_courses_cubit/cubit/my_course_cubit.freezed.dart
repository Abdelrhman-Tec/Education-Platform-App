...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MyCourseState<T>);
}
...
/// @nodoc
class $MyCourseStateCopyWith<T,$Res>  {
$MyCourseStateCopyWith(MyCourseState<T> _, $Res Function(MyCourseState<T>) __);
}


/// Adds pattern-matching-related methods to [MyCourseState].
extension MyCourseStatePatterns<T> on MyCourseState<T> {
...
class _Initial<T> implements MyCourseState<T> {
  const _Initial();
...
@override
String toString() {
  return 'MyCourseState<$T>.initial()';
}
...
class _Loading<T> implements MyCourseState<T> {
  const _Loading();
...
@override
String toString() {
  return 'MyCourseState<$T>.loading()';
}
...
class _Success<T> implements MyCourseState<T> {
  const _Success(this.data);
  

 final  T data;

/// Create a copy of MyCourseState
...
@override
String toString() {
  return 'MyCourseState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $MyCourseStateCopyWith<T, $Res> {
...
class _Failure<T> implements MyCourseState<T> {
...
@override
String toString() {
  return 'MyCourseState<$T>.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<T,$Res> implements $MyCourseStateCopyWith<T, $Res> {
