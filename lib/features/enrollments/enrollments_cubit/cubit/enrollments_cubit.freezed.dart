...
class _Success<T> implements EnrollmentsState<T> {
...
@override
String toString() {
  return 'EnrollmentsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $EnrollmentsStateCopyWith<T, $Res> {
...
class _Error<T> implements EnrollmentsState<T> {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $EnrollmentsStateCopyWith<T, $Res> {
