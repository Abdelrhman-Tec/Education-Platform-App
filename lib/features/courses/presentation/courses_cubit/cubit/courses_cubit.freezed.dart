...
class Loading<T> implements CoursesState<T> {
  const Loading();
...
class Success<T> implements CoursesState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $CoursesStateCopyWith<T, $Res> {
...
class _Failure<T> implements CoursesState<T> {
...
@override
String toString() {
  return 'CoursesState<$T>.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<T,$Res> implements $CoursesStateCopyWith<T, $Res> {
