...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Initial<T> value)?  initial,TResult Function( Loading<T> value)?  loading,TResult Function( Success<T> value)?  success,TResult Function( _Failure<T> value)?  failure,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Initial<T> value)  initial,required TResult Function( Loading<T> value)  loading,required TResult Function( Success<T> value)  success,required TResult Function( _Failure<T> value)  failure,}){
final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Initial<T> value)?  initial,TResult? Function( Loading<T> value)?  loading,TResult? Function( Success<T> value)?  success,TResult? Function( _Failure<T> value)?  failure,}){
final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial(_that);case Loading() when loading != null:
...
class Loading<T> implements CategoriesState<T> {
  const Loading();
...
@override
String toString() {
  return 'CategoriesState<$T>.loading()';
}
...
class Success<T> implements CategoriesState<T> {
...
@override
String toString() {
  return 'CategoriesState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $CategoriesStateCopyWith<T, $Res> {
...
class _Failure<T> implements CategoriesState<T> {
...
@override
String toString() {
  return 'CategoriesState<$T>.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<T,$Res> implements $CategoriesStateCopyWith<T, $Res> {
